            ...
            <div id="content">
                <div class="movie_menu">
                    ...
                    <div class="hot_swtich">
                        <router-link tag="div" to = "/movie/nowPlaying" div class="hot_item">正在热映</router-link>
                        <router-link tag="div" to = "/movie/comingSoon" div class="hot_item">即将上映</router-link>
                    </div>
